# Cordlang cheatsheet (skill bundle)

One-screen syntax. Upstream: `docs/CHEATSHEET.md`. Raw: https://raw.githubusercontent.com/cordlang/cordlang/main/docs/CHEATSHEET.md
