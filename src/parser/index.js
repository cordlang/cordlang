...
function parseCordLang(filePath) {
  ...
  const readyMessages = botMatch
    ? { success: botMatch[1], error: botMatch[2] }
    : { success: "Bot en línea!", error: "Error al iniciar el bot" };
