...
FIXTURES=(basic_counter routes_simple interp if_for nested_routes component_slot string_dotted escape_hash_brace react_phase_d svelte_phase_e preset_caps theme_design_tokens aria_hidden_bool)
